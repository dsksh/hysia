...
external put_grd_tree:  string -> int -> int -> unit = "caml_put_grd_tree"
external put_grd_dtree: string -> int -> int -> int -> unit = "caml_put_grd_dtree"

external put_jump_tree:  string -> int -> int -> unit = "caml_put_jump_tree"
external put_jump_dtree: string -> int -> int -> int -> unit = "caml_put_jump_dtree"
